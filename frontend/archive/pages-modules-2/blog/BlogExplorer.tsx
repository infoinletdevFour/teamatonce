...
import { Star, TrendingUp, Clock, Award, ArrowLeft, Filter } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="container mx-auto max-w-7xl px-4 py-8">
        {/* Header */}
        <div className="bg-gradient-to-r from-primary/10 to-primary/5 dark:from-primary/20 dark:to-primary/10 p-6 rounded-xl border border-border mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-4xl font-bold text-foreground">Explore Blogs</h1>
            ...
            <Link to="/blog/home">
              <Button
                variant="outline"
                size="sm"
                className="flex items-center gap-2 hover:bg-primary/10 border-primary/30 hover:border-primary/50 transition-all"
              >
        ...
        <div className="flex flex-wrap gap-2 mb-8 p-2 bg-gradient-to-r from-secondary/20 to-secondary/10 rounded-xl border border-border/50">
              ...
              <button
                ...
                className={`flex items-center gap-2 px-6 py-3 rounded-lg font-medium transition-all duration-300 ${
                  activeType === category.key
                    ? 'bg-primary text-primary-foreground shadow-lg hover:shadow-xl border border-primary/30'
                    : 'text-muted-foreground hover:text-foreground hover:bg-secondary/30 hover:shadow-md border border-transparent'
                }`}
              >
              ...
              <button
                ...
                className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 ${
                  selectedCategory === category
                    ...
                    : 'bg-secondary/20 text-muted-foreground hover:bg-secondary/40 hover:text-foreground hover:shadow-sm border border-border/50'
                }`}
              >
                {category === 'all'
                  ? 'All Categories'
        ...
        {!error && loading ? (
          ...
          <div className="text-center py-16 bg-gradient-to-r from-secondary/10 to-secondary/5 rounded-xl border border-border">
            ...
            <Button
              ...
              variant="outline"
              className="bg-primary hover:bg-primary/90 text-primary-foreground hover:text-primary-foreground border-primary hover:border-primary/90 shadow-md hover:shadow-lg transition-all duration-300"
            >
              View All Blogs
            </Button>
          </div>
