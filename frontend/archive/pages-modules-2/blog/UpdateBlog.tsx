        ...
        <div className="grid lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl overflow-hidden">
              <div className="p-8">
                <div className="flex items-center justify-center relative mb-2">
                  <button
                    onClick={() => navigate(-1)}
                    className="absolute left-0 p-2 text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary-dark transition-colors rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700"
                    aria-label="Go back"
                  >
          ...
          <aside>
            <div className="sticky top-24">
              <h2 className="text-2xl dark:text-primary font-bold mb-6 text-gray-900">
                Popular Posts
              </h2>
