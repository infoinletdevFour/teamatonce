  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-blue-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-background">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Header Section */}
        <div className="mb-8 p-8 rounded-3xl bg-gradient-to-r from-[#47bdff]/5 via-[#47bdff]/10 to-[#47bdff]/5 border border-[#47bdff]/20">
        ...
        {errors.general && (
          <div className="mb-6 p-4 bg-red-50/60 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg flex items-center">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
          ...
          <div className="xl:col-span-1">
            <Card className="mb-8 rounded-2xl bg-gradient-to-r from-white via-white to-[#47bdff]/5 dark:from-gray-800 dark:via-gray-800 dark:to-[#47bdff]/10 border-l-4 border-[#47bdff]">
              <CardHeader className="pb-4">
                <CardTitle className="flex items-center gap-2">
                  <Edit3 className="h-5 w-5 text-[#47bdff]" />
                  Story Details
                </CardTitle>
              ...
              <CardContent className="space-y-6">
                <div>
                  ...
                  <Input
                    ...
                    className={`mt-1 h-12 rounded-xl ${
                      errors.title
                        ? 'border-red-500'
                        : 'focus:border-[#47bdff] focus:ring-[#47bdff]/20'
                    }`}
                  />
                ...
                <div>
                  ...
                  >
                    <SelectTrigger id="level" className="mt-1 h-12 rounded-xl">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                      {levels.map((level) => (
                ...
                <div>
                  ...
                  >
                    <SelectTrigger id="category" className="mt-1 h-12 rounded-xl">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                ...
                {/* Story Statistics */}
                <div className="mt-6 p-4 bg-gray-50/60 dark:bg-gray-800/60 rounded-xl">
          ...
          <div className="xl:col-span-2">
            <Card className="mb-8 rounded-2xl bg-gradient-to-r from-white via-white to-[#47bdff]/5 dark:from-gray-800 dark:via-gray-800 dark:to-[#47bdff]/10 border-l-4 border-[#47bdff]">
              <CardHeader className="pb-4">
                <CardTitle className="flex items-center gap-2">
                  <BookOpen className="h-5 w-5 text-[#47bdff]" />
                  Story Content
                </CardTitle>
                <CardDescription>
              ...
              <CardContent className="space-y-6">
                <div>
                  ...
                  <textarea
                    ...
                    rows={20}
                    className={`w-full mt-1 px-4 py-3 border-2 rounded-xl resize-none focus:outline-none focus:ring-3 focus:ring-[#47bdff]/15 ${
                      errors.content
                        ? 'border-red-500 bg-red-50/40 dark:bg-red-900/15'
                        : 'border-gray-200 focus:border-[#47bdff] hover:border-[#47bdff]/60'
        ...
        <div className="flex flex-col sm:flex-row justify-end gap-4">
          ...
          <Button
            ...
            className="h-12 px-8 rounded-xl bg-gradient-to-r from-[#47bdff] to-[#47bdff]/90 hover:from-[#47bdff]/90 hover:to-[#47bdff]/80 text-white border-0 font-semibold transition-all duration-300 hover:scale-105"
          >
