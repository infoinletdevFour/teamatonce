    ...
    return (
      <div className="space-y-6">
        <div className="text-center py-12">
          ...
          <Button onClick={() => navigate('/meditation/series')}>Back to Series</Button>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Button variant="ghost" size="icon" onClick={() => navigate('/meditation/series')}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-4">
                ...
                {isStarted && <Badge className="bg-primary text-white">In Progress</Badge>}
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-muted-foreground">{series.sessions} sessions</span>
                </div>
                <div className="flex items-center gap-2">
                  <Clock className="h-4 w-4 text-primary" />
                  <span className="text-sm text-muted-foreground">{series.totalDuration}</span>
                </div>
                <div className="flex items-center gap-2">
                  <Target className="h-4 w-4 text-primary" />
                  <span className="text-sm text-muted-foreground">{series.difficulty}</span>
                </div>
                <div className="flex items-center gap-2">
        ...
        <Card className="p-6 bg-card border">
          <h4 className="text-lg font-semibold text-foreground mb-4">Your Guide</h4>
          <div className="space-y-4">
            ...
            <div>
              <h5 className="font-semibold text-foreground">{series.instructor}</h5>
              <p className="text-sm text-muted-foreground">Meditation Teacher</p>
            </div>
            <p className="text-sm text-muted-foreground leading-relaxed">
              {series.instructor === 'Widest Life Team'
      ...
      {/* Sessions List */}
      <div>
        <h3 className="text-xl font-semibold text-foreground mb-6">All Sessions</h3>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      {isCurrent && (
                        <Badge className="bg-primary text-white text-xs">Up Next</Badge>
                      )}
                      {isCompleted && (
                        <Badge className="bg-primary text-white text-xs">Completed</Badge>
                      )}
                    </div>
